  ...
  <div>
    <el-form :model="registerForm" label-position="left">
      <el-form-item prop="fatherId" label="父账号名称：">
        <el-input v-model="registerForm.fatherId" placeholder="父账号名称" prefix-icon="el-icon-user" />
      </el-form-item>
      <el-form-item prop="fatherName" label="父账号ID：">
        <el-input v-model="registerForm.fatherName" placeholder="父账号ID" prefix-icon="el-icon-user" />
      </el-form-item>
