...
@EnableJpaRepositories(
        ...
        basePackages = {"com.visualization.repository.dag", "com.visualization.repository.file"}) //设置Repository所在位置
public class JPAConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryDAG(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                //设置实体类所在位置
                .packages("com.visualization.model.dag", "com.visualization.model.file")
